                ...
                <table>
                    ...
                    <c:forEach var="lineItem" items="${sessionScope.order.lineItems}">
                        <tr>
                            ...
                            <td>${lineItem.unitPrice}<fmt:formatNumber value="${lineItem.unitPrice}"
                                                  pattern="$#,##0.00"/></td>
                            <td>${lineItem.total}<fmt:formatNumber value="${lineItem.total}"
                                                  pattern="$#,##0.00"/></td>
                        </tr>
                    </c:forEach>
                    <tr>
                        <th colspan="5">Total: ${sessionScope.order.totalPrice}<fmt:formatNumber
