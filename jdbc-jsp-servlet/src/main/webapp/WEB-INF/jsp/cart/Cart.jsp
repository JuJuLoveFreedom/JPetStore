...
<div id="Catalog">
    ...
    <div id="Cart">
            ...
            <table>
                ...
                <c:forEach var="cartItem" items="${sessionScope.cart.cartItems}">
                    <tr>
                        ...
                        <td><input type="text" name="${cartItem.item.itemId}"
                        ...
                        <td><<a href="removeItemFromCart?itemId=${cartItem.item.itemId}">Remove</a>>
                        </td>
                    </tr>
                </c:forEach>
                <tr>
        ...
        <c:if test="${sessionScope.cart.numberOfItems > 0}">
            <<a href="/proceedToCheckout">Proceed to Checkout</a>>
